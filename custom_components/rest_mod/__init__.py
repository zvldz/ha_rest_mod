...
from .const import COORDINATOR, DOMAIN, PLATFORM_IDX, REST, REST_DATA, REST_IDX, CONF_PAYLOAD_TEMPLATE, CONF_PROXY_URL
from .data import RestDataMod
...
def create_rest_data_from_config(hass, config):
    """Create RestDataMod from config."""
